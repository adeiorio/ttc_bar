    ...
    def analyze(self, event):
        ...
        for mu in muons:
            ...
            if mu.pt < 15:
                ...
                Muon_topMVA_Tight_SFerr_syst.append(error)
                Muon_topMVA_Tight_SFerr_stat.append(error)
                Muon_topMVA_Medium_SF.append(value)
                Muon_topMVA_Medium_SFerr_syst.append(error)
                Muon_topMVA_Medium_SFerr_stat.append(error)
                Muon_topMVA_Loose_SF.append(value)
                Muon_topMVA_Loose_SFerr_syst.append(error)
                Muon_topMVA_Loose_SFerr_stat.append(error)
            else: 
