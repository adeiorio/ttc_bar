...
class BHProducer(Module):
    ...
    '''
        ...
        for tau in taus:
            ...
            if tau.pt>20 and abs(tau.eta)<2.3 and abs(tau.dz)<0.2 and tau.idDecayModeNewDMs and tau.idDeepTau2017v2p1VSe>=4 and tau.idDeepTau2017v2p1VSjet>=4 and tau.idDeepTau2017v2p1VSmu>=1: # use this for non-nanoaodv9
